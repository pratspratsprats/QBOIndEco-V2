...
<div id="wrapper">
    ...
    <div id="body">
            ...
            <div class="blocks">
                ...
                <div class="block keyFeatures">
					...
					<ul>
						...
						<br />
						<li><b><a href="syncKRData.htm" style="color:#0000FF;">Sync KR Data</a></b></li>
					</ul>
						...
						<tbody>                            
							...
							<tr>                           
								<td>${customer.displayName}</td>            
									<c:set var="completeAddress" value="${customer.billAddr.line1} ${customer.billAddr.line1} ${customer.billAddr.line1} ${customer.billAddr.line1}"/>
        ...
        <div class="container">
        	<c:if test="${not empty syncStatus}">
        		<div class="smallHeading">
